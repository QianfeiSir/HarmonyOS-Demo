...
import com.example.helloworld.util.CircleProgressDrawTask;
...
//        imageComponent.setBackground(new VectorElement(context, ResourceTable.Media_Media_ic_icon_moon));
    }
